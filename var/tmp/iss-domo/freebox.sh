...
# ISS-Domo Server
ISSDOMO_SERVER="192.168.0.8:8000"
# Domoticz server
DOMOTICZ_SERVER="192.168.0.8:8080"
#
# Freebox Server Temp SW idx
FREE_SERV_TEMP_SW="14"
#
# Freebox Server Temp CPU B idx
FREE_SERV_TEMP_CPU_B="13"
#
# Freebox Server Temp CPU M idx
FREE_SERV_TEMP_CPU_M="12"
#
...
curl --silent -s -i -H  "Accept: application/json"  "http://$DOMOTICZ_SERVER/json.htm?type=command&param=udevice&idx=$FREE_SERV_FAN&svalue=$FAN"
